...
// API base
const API_BASE =
  process.env.NEXT_PUBLIC_API_BASE || "http://localhost:8001/graph/non-equilibrium-quantum-field-theory";
...
// ──────────────────────────────────────────────
export default function NonEquilibriumQFTPage() {
    ...
    <div className="flex flex-col gap-6 p-6 max-w-6xl mx-auto">
      ...
      <div>
        <h1 className="text-2xl font-bold tracking-tight">
          Non-Equilibrium Quantum Field Theory Engine
        </h1>
        <p className="text-sm text-muted-foreground mt-1">
          Layer 77 (v1.325.0) — Bridges quantum topological field theory (L75) with lattice QCD:
