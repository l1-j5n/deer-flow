...
// API base
const API_BASE =
  process.env.NEXT_PUBLIC_API_BASE || "http://localhost:8001/graph/quantum-chromodynamics-lattice";
...
// ──────────────────────────────────────────────
export default function QuantumChromodynamicsLatticePage() {
    ...
    <div className="flex flex-col gap-6 p-6 max-w-6xl mx-auto">
      ...
      <div>
        <h1 className="text-2xl font-bold tracking-tight">
          Quantum Chromodynamics Lattice Engine
        </h1>
        <p className="text-sm text-muted-foreground mt-1">
          Layer 76 (v1.324.0) — Bridges quantum topological field theory (L75) with lattice QCD:
