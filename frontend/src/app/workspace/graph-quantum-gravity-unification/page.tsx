...
// API base
const API_BASE =
  process.env.NEXT_PUBLIC_API_BASE || "http://localhost:8001/graph/quantum-gravity-unification";
...
// ──────────────────────────────────────────────
export default function QuantumGravityUnificationPage() {
    ...
    <div className="flex flex-col gap-6 p-6 max-w-6xl mx-auto">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Layer 80 (v1.328.0) — Bridges quantum topological field theory (L75) with lattice QCD:
